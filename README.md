...
MinerviLism は、Python の分析・バックテスト基盤、FastAPI の API 層、React の可視化 UI、Electron のデスクトップ実行導線をまとめた株式分析ワークスペースです。Python が生成した成果物を backend が API 化し、frontend と Electron が同じ契約に基づいて表示します。
